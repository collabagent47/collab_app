...
1. Lee `.github/guidelines/automation/automation-guidelines.md`
2. Si no existe ese archivo, usa los estándares de la industria para CI/CD
3. Confirma la carga antes de continuar

```
📌 Cargando lineamientos desde:
   .github/guidelines/automation/automation-guidelines.md
...
**Archivo:** `.github/skills/automation/pipeline-config-generator.md`
**Actívala cuando:**
...
**Archivo:** `.github/skills/automation/readme-doc-writer.md`
**Actívala cuando:**
...
**Archivo:** `.github/skills/automation/release-notes-generator.md`
**Actívala cuando:**
