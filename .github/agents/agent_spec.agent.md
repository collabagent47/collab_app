...
Crea el archivo `docs/specs/specification.md` con todo el contenido
...
📄 Documento generado:         docs/specs/specification.md
...
- El documento `docs/specs/specification.md` es inmutable una vez aprobado
