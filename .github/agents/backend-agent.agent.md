...
1. Lee `.github/guidelines/dev/dev-guidelines.md`
...
📌 Cargando lineamientos desde:
   .github/guidelines/dev/dev-guidelines.md
...
**Archivo:** `.github/skills/backend/clean-code-reviewer.md`
**Actívala cuando:**
...
**Archivo:** `.github/skills/backend/integration-test-generator.md`
**Actívala cuando:**
...
**Archivo:** `.github/skills/backend/contract-test-generator.md`
**Actívala cuando:**
