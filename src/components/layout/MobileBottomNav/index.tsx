...
const NAV_ITEMS = [
  ...
  { to: '/explorations/new', label: 'Explorar', icon: Compass, end: false },
  { to: '/academy', label: 'Academia', icon: GraduationCap, end: false },
  { to: '/knowledge-base', label: 'Base', icon: Database, end: false },
]
